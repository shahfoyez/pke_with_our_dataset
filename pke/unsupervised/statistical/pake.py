...
class PAKE(LoadFile):
    ...
    def _feature_extraction(self):
        ...
        for word in self.words:
            ...
            self.features[word]['weight'] = B / (A + C + E + TPos)
    ...
    def get_n_best(self,
        ...
        for index, keyword in enumerate(input):
            ...
            for target in rest:
                vector1 = text_to_vector(keyword.lower())
                vector2 = text_to_vector(target.lower())
        ...
        print("After checking Similarity**********************")
        print(best)
        print("Top 10*****************************************")
